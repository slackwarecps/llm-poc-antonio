...
def criar_tabela_dynamodb_execucao(dynamodb=None):
    ...
    tabela_nome = 'poc_azul_execucao'
    chave_particao_nome = 'telefone'
    chave_particao_tipo = 'S'  # 'S' para String
    chave_ordenacao_nome = 'created_at'
    chave_ordenacao_tipo = 'N'  # 'N' para Número (inteiro)
